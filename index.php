...
?>
        ...
        <div class="specialists" id="specialists">
            <div class="container">
                <div class="title"><?php the_field('our_title');?></div>
                <div class="row">
                    <div class="col-lg-10 offset-lg-1">
                        <img class="specialists__img" src="<?php the_field('our_photo');?>" alt="наша команда">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="toys" id="toys">
            <div class="container">
                <h2 class="subtitle"><?php the_field('toys_1');?></h2>
                ...
                <h2 class="subtitle"><?php the_field('toys_2');?></h2>
                <div class="toys__wrapper">
